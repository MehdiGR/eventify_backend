...
class User extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    {
        return $this->hasMany(Event::class, 'organizer_id'); // Events organized by the user
    }

    public function participatedEvents()
    {
        return $this->belongsToMany(Event::class, 'event_participants'); // Events the user is participating in
    }
}
